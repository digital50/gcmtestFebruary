...
public:
    ...
    void retranslateUi(QWidget *InformationBoxPage)
    {
        ...
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_7), QApplication::translate("InformationBoxPage", "GoCoin Chat", 0));
        groupBox->setTitle(QApplication::translate("InformationBoxPage", "Auto Chat Invite", 0));
        label->setText(QApplication::translate("InformationBoxPage", "<html><head/><body><p>All users need to be invited to GoCoinChat. </p><p>If you need an invite please click GoCoinChat Invite.</p></body></html>", 0));
        pushButton->setText(QApplication::translate("InformationBoxPage", "GoCoinChat Invite", 0));
