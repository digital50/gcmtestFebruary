...
const string strMessageMagic = "GoCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1485946000, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        assert(block.hashMerkleRoot == uint256("0x3d12ce7435fb91449e43f21520e3f925245337c08a4db98499ae380f922ec9d3"));
...
unsigned char pchMessageStart[4] = { 0xa4, 0x76, 0x46, 0xd4 };
